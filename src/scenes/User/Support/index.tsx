...
import { Form, Typography, Input, Button, notification, Upload, Modal } from 'antd'
...
const Support = () => {
    ...
    const onFinish = (values: any) => {
        ...
        notification.success({
            ...
            description: 'Hi there, Book Over There has take your ticket. We will response to you as soon as possible. Please check your email for further info. Thank you & have a nice day!!'
        })
    };
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Title level={2} style={{ textAlign: 'center', marginBottom: "30px" }}>Support Center</Title>
                <Form
                    {...layout}
                    ref={formRef}
                    name="control-ref"
